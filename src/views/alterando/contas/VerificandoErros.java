...
public class VerificandoErros {
	...
	public static boolean verificando(String numeroDoDocumento,
			String numeroOriginal, String valor, String tipoDaConta,
			String origem, String dataDeEntrada, String dataDeVencimento)
			throws SQLException {
		...
		try {
			...
			if (numeroDoDocumento.equals(numeroOriginal)) {
