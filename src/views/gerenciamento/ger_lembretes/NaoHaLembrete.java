...
public class NaoHaLembrete extends JFrame implements KeyListener, MouseListener {
	...
	public NaoHaLembrete() {
		...
		fundo.setIcon(new ImageIcon(
				NaoHaLembrete.class
						.getResource("/views/gerenciamento/ger_lembretes/jpg/Nenhum_Lembrete.jpg")));
