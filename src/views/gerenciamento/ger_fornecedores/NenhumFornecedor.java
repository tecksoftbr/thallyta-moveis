...
public class NenhumFornecedor extends JFrame implements KeyListener,
		MouseListener {
	...
	public NenhumFornecedor() {
		...
		fundo.setIcon(new ImageIcon(
				NenhumFornecedor.class
						.getResource("/views/gerenciamento/ger_fornecedores/jpg/Nenhum_Fornecedor.jpg")));
